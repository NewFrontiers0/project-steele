...
SWIM_HTTP_CHUNK_BYTES="${SWIM_HTTP_CHUNK_BYTES:-4096}"
SWIM_HTTP_CHUNK_DELAY_MS="${SWIM_HTTP_CHUNK_DELAY_MS:-1}"
SWIM_HTTP_INITIAL_DELAY_MS="${SWIM_HTTP_INITIAL_DELAY_MS:-250}"
SWIM_HTTP_TCP_MAXSEG="${SWIM_HTTP_TCP_MAXSEG:-536}"
SWIM_HTTP_SNDBUF_BYTES="${SWIM_HTTP_SNDBUF_BYTES:-16384}"
...
export SWIM_FILE_PORT SWIM_HTTP_PROFILE SWIM_HTTP_CHUNK_BYTES SWIM_HTTP_CHUNK_DELAY_MS SWIM_HTTP_INITIAL_DELAY_MS
export SWIM_HTTP_TCP_MAXSEG SWIM_HTTP_SNDBUF_BYTES SWIM_FTP_PORT SWIM_FTP_PASSIVE_PORTS SWIM_TFTP_PORT
